...
import { Layout, Tabs, TabPane, Typography, Button, Tag } from '@douyinfe/semi-ui';
import { useTranslation } from 'react-i18next';
import { Image, Video, FolderOpen, KeyRound } from 'lucide-react';
  ...
  return (
    <div className='h-full'>
      ...
      <Layout className='h-full bg-transparent flex flex-col'>
        <div className='mt-[60px] px-4 pt-3 pb-1 flex items-center justify-between border-b border-gray-100'>
          ...
          <div className='flex items-center gap-3'>
            ...
            <Button
              size='small'
              theme={token?.key ? 'borderless' : 'solid'}
