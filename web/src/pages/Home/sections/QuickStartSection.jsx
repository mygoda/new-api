    ...
    <section className='py-20 bg-white border-y border-slate-100'>
      <div className='max-w-6xl mx-auto px-6'>
        ...
        <div className='grid grid-cols-1 md:grid-cols-3 gap-4'>
          {/* 开发者 */}
          <div className='hover-card rounded-2xl border-2 border-slate-200 p-6 relative bg-white'>
          ...
          {/* 客户端用户 */}
          <div className='hover-card rounded-2xl border-2 border-slate-200 p-6 bg-white'>
          ...
          {/* 网页用户 */}
          <div className='hover-card rounded-2xl border-2 border-indigo-500 p-6 relative bg-gradient-to-b from-indigo-50/40 to-transparent'>
            ...
            <Link
              to='/creation'
              className='block w-full text-center px-4 py-2 bg-slate-900 text-white rounded-full text-sm font-medium hover:bg-slate-800'
            >
              {t('立即打开 →')}
            </Link>
          </div>
