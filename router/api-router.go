...
func SetApiRouter(router *gin.Engine) {
	...
	apiRouter.Use(middleware.GlobalAPIRateLimit())
	{
		...
		apiRouter.GET("/site_info", controller.GetSiteInfo)
		...
		userRoute := apiRouter.Group("/user")
		{
			...
			selfRoute.Use(middleware.UserAuth())
			{
				...
				selfRoute.GET("/subordinates", controller.GetSubordinates)
			}
			...
			adminRoute.Use(middleware.AdminAuth())
			{
				...
				adminRoute.GET("/:id/subordinates", controller.GetUserSubordinates)
		...
		optionRoute.Use(middleware.RootAuth())
		{
			...
			optionRoute.POST("/test/feishu", controller.TestFeishuAlert)
			optionRoute.POST("/test/creation_storage", controller.TestCreationStorage)
			optionRoute.GET("/channel_affinity_cache", controller.GetChannelAffinityCacheStats)
			optionRoute.DELETE("/channel_affinity_cache", controller.ClearChannelAffinityCache)
			optionRoute.POST("/rest_model_ratio", controller.ResetModelRatio)
			optionRoute.GET("/conditional_ratios/families", controller.GetConditionalRatioFamilies)
			optionRoute.GET("/conditional_ratios/dimensions", controller.GetConditionalRatioDimensions)
		...
		groupRoute.Use(middleware.AdminAuth())
		{
			...
			groupRoute.PUT("/:name/channel_weight", controller.UpdateGroupChannelWeightHandler)
		}
