...
func SetApiRouter(router *gin.Engine) {
	...
	apiRouter.Use(middleware.GlobalAPIRateLimit())
	{
		...
		apiRouter.GET("/marketplace/models", middleware.AdminAuth(), controller.GetMarketplaceModels)
		apiRouter.GET("/marketplace/models/:name", middleware.AdminAuth(), controller.GetMarketplaceModelDetail)
